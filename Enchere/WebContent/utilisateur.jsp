	...
	<div class="MonProfil">
		...
		<form action="UtilisateurServlet" method="post" class="wrapper">
			<table align="center">
				...
				<tr>
					<td>Téléphone :<input type="text" name="telephone"
						pattern="[0-9]*" /></td>
					<td>Rue* :<input type="text" name="rue" required /></td>
				</tr>
				<tr>
					<td>Code postal* :<input type="text" name="codePostal"
						required pattern="[0-9]*" /></td>
					<td>Ville* :<input type="text" name="ville" required /></td>
				</tr>
				<tr>
					<td>Password* :<input type="password" name="motDePasse"
						required /></td>
					<td>Confirmation* :<input type="password" name="motDePasse2"
						required /></td>
				</tr>

				<tr>
					<td><a href="/Enchere/AccueilNonConnectePagination6Servlet"><input
