...
<body>
	...
	<form action="ModifierVenteServlet" method="post">
		...
		Article :<input type="text" name="nomArticle"
			value="${articleVenduModel.articleVendu.nomArticle}" /> <br>
		Description : <br>
		...
		</select> <br> Photo de l'article : <img
			src="images/Utilisateur${user.noUtilisateur}/${articleVenduModel.articleVendu.refPhoto}"
			width='80' height='80' /> <br> Mise à prix :<input type="number"
			name="miseAPrix" value="${articleVenduModel.articleVendu.miseAprix}"
			min="0" step="1" /> <br> Début de l'enchère :<input type="date"
			name="dateDebutEnchere"
			value="${articleVenduModel.articleVendu.dateDebutEncheres}" /> <br>

		Fin de l'enchere :<input type="date" name="dateFinEnchere"
			value="${articleVenduModel.articleVendu.dateFinEncheres}" /> <br>
		Retrait : <br> Rue: <input type="text" name="rue"
	...
	<a href="/Enchere/ListeEncheresConnectePagination6Servlet"><input
		type="button" value="Annuler"> <br>

		<form action="SuppressionUnArticleVendu">
			<input type="hidden" name="noArticleVendu"
				value="${articleVenduModel.articleVendu.noArticle}"> <input
				type="submit" value="Annuler la vente">

		</form> <a
		href="<%=request.getContextPath()+"/UploadFileServlet"%>?noArticleVendu=${articleVenduModel.articleVendu.noArticle}"><input
			type="button" value="Modifier photo"></a>
</body>
</html>