...
<body>
	<h1><a href="/Enchere/ListeEncheresConnectePagination6Servlet">ENI-ENCHERE</a></h1>
	...
	<form action="ListeEncheresConnectePagination6RechercheServlet" method="post">
        ...
        <ul class="pagination">
            <c:if test="${currentPage != 1}">
                <li class="page-item"><a class="page-link"
                    href="ListeEncheresConnectePagination6RechercheServlet?currentPage=${currentPage-1}">Previous</a>
                </li>
            </c:if>
            ...
            <c:forEach begin="1" end="${noOfPages}" var="i">
                <c:choose>
                    ...
                    <c:otherwise>
                        <li class="page-item"><a class="page-link"
                            href="ListeEncheresConnectePagination6RechercheServlet?currentPage=${i}">${i}</a>
                        </li>
                    </c:otherwise>
                </c:choose>
            </c:forEach>
            ...
            <c:if test="${currentPage lt noOfPages}">
                <li class="page-item"><a class="page-link"
                    href="ListeEncheresConnectePagination6RechercheServlet?currentPage=${currentPage+1}">Next</a>
                </li>
            </c:if>
        </ul>
    </nav>
