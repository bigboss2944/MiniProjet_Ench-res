...
<body>
	...
	${retrait.ville}
	<br> Vendeur: ${vendeur.pseudo}
	<br> Tel: ${vendeur.telephone}
	<br>
	<a href="/Enchere/listeEncheresConnecte.jsp "><input type="button"
		value="Back"></a>
