 ...
 */
@WebServlet("/AdminDesactiverCompteServlet")
public class AdminDesactiverCompteServlet extends HttpServlet {
     ...
     */
    public AdminDesactiverCompteServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (noUtilisateurStr != null) {
			...
			try {
				managerUtilisateurs.modifierEtatCompte(noUtilisateur, "N");
				request.setAttribute("message", "Un compte est bien désactivé");
