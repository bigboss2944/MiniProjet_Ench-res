 ...
 */
@WebServlet("/ListeEncheresConnectePagination6RechercheServlet")
public class ListeEncheresConnectePagination6RechercheServlet extends HttpServlet {
	 ...
	 */
	public ListeEncheresConnectePagination6RechercheServlet() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (request.getSession().getAttribute("user") != null  ) {
			...
			request.getRequestDispatcher("listeEncheresConnectePagination6Recherche.jsp").forward(request, response);
		} else {
