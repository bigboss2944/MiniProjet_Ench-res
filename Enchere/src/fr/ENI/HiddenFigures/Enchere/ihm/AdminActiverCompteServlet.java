 ...
 */
@WebServlet("/AdminActiverCompteServlet")
public class AdminActiverCompteServlet extends HttpServlet {
     ...
     */
    public AdminActiverCompteServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (noUtilisateurStr != null) {
			...
			try {
				managerUtilisateurs.modifierEtatCompte(noUtilisateur, "A");
				request.setAttribute("message", "Un compte est bien activé");
